  ...
  return (
    <div className="min-h-screen bg-[#F4F4F5] pb-24" data-testid="checkin-page">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl border-2 border-zinc-200 p-4 space-y-4">
          ...
          <div>
            ...
            <input type="text" value={form.aadhar_number} onChange={(e) => updateField('aadhar_number', e.target.value)}
              className="w-full h-14 px-4 rounded-xl border-2 border-zinc-200 text-lg font-medium focus:border-zinc-900 focus:outline-none" placeholder="XXXX XXXX XXXX" data-testid="aadhar-input" />
          </div>
          <div>
        ...
        {/* Payment Section */}
        <div className="bg-white rounded-2xl border-2 border-zinc-200 p-4 space-y-4">
          <label className="text-xs uppercase tracking-[0.1em] font-bold text-zinc-500 block">{lang === 'mr' ? 'पेमेंट माहिती' : 'Payment Info'}</label>
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input type="number" value={form.rate_per_day} onChange={(e) => updateField('rate_per_day', parseFloat(e.target.value) || 0)}
                className="w-full h-14 px-4 rounded-xl border-2 border-zinc-200 text-lg font-medium focus:border-zinc-900 focus:outline-none" data-testid="rate-input" />
            </div>
          </div>
          <div>
            ...
            <input type="number" value={form.advance_paid} onChange={(e) => updateField('advance_paid', parseFloat(e.target.value) || 0)}
              className="w-full h-14 px-4 rounded-xl border-2 border-zinc-200 text-lg font-medium focus:border-zinc-900 focus:outline-none" data-testid="advance-input" />
          </div>
          <div>
